...
HD_PWD='C:/Users/ea09904/Downloads/project_1ca/project_1ca/project_1ca.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MemorySystem_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MemorySystem_top.tcl -notrace
