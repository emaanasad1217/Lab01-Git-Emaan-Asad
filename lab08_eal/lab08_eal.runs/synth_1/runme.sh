...
HD_PWD='C:/Users/ea09904/Downloads/project_1ca/project_1ca/project_1ca.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MemorySystem_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MemorySystem_top.tcl
